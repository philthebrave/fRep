...
const CountdownTimer = ({ initialSeconds, warningSeconds }) => {
  ...
  return (
    ...
    <div className="timer">
      ...
      <button class="bigbutton" onClick={startTimer} disabled={isRunning || secondsLeft === 0}>Start Recovery</button>
      <div className="buttonrow">
        <button onClick={stopTimer} disabled={!isRunning}>Stop</button>
        <button onClick={resetTimer} disabled={secondsLeft === initialSeconds}>Reset</button>
      </div>
    </div>
    <div className="reps">
    <h3>Rep Counter</h3>
    {newRepCount}
    <button class="bigbutton" onClick={() => setnewRepCount(AddRep(newRepCount))} disabled={isRunning}>REP</button>
